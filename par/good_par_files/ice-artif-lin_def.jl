...
time_end = 2.0e6 # [yr] Ending time (model years)
...
f_1 = 3.0e-8 # [--] fraction of the sediments that is removed beacause of U # Golledge 2013 indicates a typical bed erosion of 10-3 mm/yr (for a speed of ~1 km/yr ==> f1 ~ 1e-6)
