Base.@kwdef struct Params
    ...
    Psl::Real = 101325                # [Pa] Pressure at sea level
    ...
    zb0::Real = 500.0                   # [m] Inital condition for bed elevation
    ...
    s_case::String = "linear"               # Clausius-Clapeyron approximation: "ins", "linear"
    a_case::String = "ITM"                  # Surface melting case: "PDD", "ITM"
    ...
    Iday::Real = 170.0                   # Day in which calculate insolation
    Ilat::Real = 65.0                    # [ºN] Latitude in which calculate the insolation in the northern hemisphere 

    # -- Radiative forcing parameters   
    Iinput::String = "data/insolation/solstice_insolation_65N170_10yr_5MyrBP-0.jld2"    # File to read as input if I_case = "input"
    Iconst::Real = 400.0               # [W/m²] Insolation value for constant insolation mode
    Imin::Real = 425.0                 # [W/m²] Insolation minimum value 
    Imax::Real = 565.0                 # [W/m²] Insolation maximum value
    Ithreshold = 300.0                  # [W/m²] Insolation threshold value for integrated summer insolation, Huybers (2006) used 275 W/m²

    Iref::Real = 480.0                   # [W/m²] Present reference value for insolation 
    pCO2ref::Real = 280.0                 # [ppm] Reference value for pCO2dot
    taupCO2::Real = 10.0                  # [yr] Characteristic time for pCO2 evolution
    ...
    pCO2anth::Real = 3000.0               # [Gt] Anthropogenic amount of pCO2 produced
    Atanth::Real = 55.0                  # [ºC or K] Amplitude of anthropogenic temperature forcing (sea level temperatures)
    Acanth::Real = 20.0                  # [ppm] Amplitude of anthropogenic radiative forcing
    tauanth::Real = 200e3                # [yr] Relaxation time for anthropogenic forcing

    alphaland::Real = 0.2               # [--] ground albedo
    alphaoldice::Real = 0.25            # [--] old ice albedo
    alphanewice::Real = 0.9             # [--] new ice albedo 
    kalpha::Real = 5e-6             # [yr⁻¹] Slope of the albedo - ice age parameterization (1 per 100 kyrs)
    alphaquad::Real = 1e-10             # [yr⁻²] Sensitivity of the albedo - ice age quadratic parameterization (1 per 100 kyrs)        
    taualpha::Real = 1e3                # [yr] Characteristic time of albedo evolution w.r.t reference value
    ...
    zbeq::Real = 500.0                    # [m] equilibrium altitude of the bedrock
    taubed::Real = 5000.0               # [years] relaxation time for the astenosphere
    ...
    Ata::Real = 20.0                      # [K] Thermal amplitude due to ice-sheet area (Northern Hemisphere)
end
