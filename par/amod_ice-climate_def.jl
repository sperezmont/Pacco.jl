### Run Settings (CTL)
time_init = -8.0e5 # [yr] Starting time (model years)
...
csi = 0.09 # [K/Wm²] climate sensitivity to insolation
...
f_1 = 1.0e-6 # [--] fraction of the sediments that is removed beacause of U # Golledge 2013 indicates a typical bed erosion of 10-3 mm/yr (for a speed of ~1 km/yr ==> f1 ~ 1e-6)
...
C_s = 1.0e-7 # [m yr⁻¹ Pa⁻²] Raw sliding parameter (between 10^(-10) and 10^(-5) in Pollard and deConto (2012) after Schoof (2007)) 1e-7 by default??
...
lambda = 0.08 # [m yr⁻¹ K⁻¹] Proportionality between positive temperatures and surface melt
...
ki = 0.05 # [m/yr/Wm²] sensitivity parameter of insolation melting ! 0.006 the default?
