### Run Settings (CTL)
time_init = -2.0e6              # [yr] Starting time (model years)
...
# -- Cases
ins_case = "artificial"         # Insolation case: "constant", "artificial", "laskar"
...
f_1 = 5e-8                      # [--] fraction of the sediments that is removed beacause of U # Golledge 2013 indicates a typical bed erosion of 10-3 mm/yr (for a speed of ~1 km/yr ==> f1 ~ 1e-6)
...
pr_ref = 1.0                      # [m/yr] Reference value for precipitation
...
ka = 0.001                      # [m/yr/K] sensitivity parameter of accumulation to temperature (Clasuius clapeyron like) ! 0.004 the default?
